...
glove_file = 'C:/Users/alumno/Practica2/glove/glove.6B.50d.txt'
glove_dir = 'C:/Users/alumno/Practica2/glove/'
...
df = pd.read_csv('C:/Users/alumno/Practica2/papers.csv') # Modificar al vuestro
...
history = model.fit(X, Y, epochs=10, validation_split=0.1, batch_size=4096)
